...
class Question
{
    ...
    public function myquestion(Request $request)
    {
        ...
        if($dbdata==null){
            ...
            $sql = "select question_answer.*,user.nickName,user.avatarUrl from question_answer,user where question_answer.question_userid=user.id and question_answer.answer_userid='". $answer_userid."' ORDER BY question_answer.create_time desc;" ;
